...
using Content.Client.UserInterface.Systems.Objectives;
...
public sealed partial class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private JobObjectivesUIController _jobObjectives = default!;
